...
\$name
     ...
     * @return string
     */
    protected function getTreeListnew($model)
    {

        $data = $model->order('sort','asc')->column('id,name,parent_id', 'id');
     ...
     * @return string
     */
    protected function getSelectListnew($model, $selected = 0)
    {
        $data = $model->order('sort','asc')->column('id,parent_id,name', 'id');
